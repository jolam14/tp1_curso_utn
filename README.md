...
Cabecera (.bar): Se utilizó un contenedor principal para agrupar el logo de la empresa y el título principal (<h1>) a la izquierda mediante un subcontenedor, separándolos del botón de configuración de tema situado a la derecha mediante Flexbox.
